                    ...
                    <div class="panel panel-primary"><!-- panel panel-primary begin -->
                        ...
                        <div class="panel-footer"><!-- panel-footer begin -->
                            <center><!-- center begin -->
                                ...
                                <a href="index.php?delete_slide=<?php echo $slide_id; ?>" class="btn btn-danger"><!-- pull-right begin -->
                                ...
                                <div class="pull-left">
                                <a href="index.php?edit_slide=<?php echo $slide_id; ?>" class="btn btn-warning"><!-- pull-left begin -->
