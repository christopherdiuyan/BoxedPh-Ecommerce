                    ...
                    <table id="datatableid" class="table table-hover table-striped table-bordered"><!-- tabel tabel-hover table-striped table-bordered begin -->
                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <tr><!-- tr begin -->
                                ...
                                <form method="POST"> 
                                <a href="index.php?edit_cat= <?php echo $cat_id; ?>"class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Edit </a> 
                                
                                <a href="index.php?delete_cat= <?php echo $cat_id; ?>" name="delete_service" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Remove </a>
                                </form> 
                                </td>
                            </tr><!-- tr finish -->
