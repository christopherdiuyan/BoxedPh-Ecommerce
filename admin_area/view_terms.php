                        ...
                        <div class="panel-footer"><!-- panel-footer begin -->
                            <center><!-- center begin -->
                                ...
                                <div class="pull-right">
                                    <a href="index.php?delete_term=<?php echo $term_id; ?>" class="btn btn-danger"><!-- pull-right begin -->
                                     <span class="fa fa-trash"></span> Delete
                                    </a><!-- pull-right finish -->
                                </div>
                                <div class="pull-left">
                                    <a href="index.php?edit_term=<?php echo $term_id; ?>" class="btn btn-warning"><!-- pull-left begin -->
