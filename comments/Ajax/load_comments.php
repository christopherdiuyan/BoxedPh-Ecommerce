...
<div class="comment-area" id="reply_comment">
    <div class="comment-area-text" style="width: 80%;">
        <textarea class="form-control" style="font-size: 1.5em;"id="usercommentreplay" rows="3"
            placeholder="Write Something."></textarea>
    </div>
    <div class="comment-area-btn">
        <button type="submit" class="btn btn-lg btn-primary comment-btn">Add Reply</button>
        <button type="button" id="close_rep" class="btn btn-lg btn-danger comment-btn mt-1">Close</button>
    </div>
...
<?php
    ...
    This product has no questions.</th>
    </tr>
    <tr>
    <th style='text-align: center;font-size:1em;'>Let others know what do you think and be the first to write a questions.</th>
    </tr>
    </center>";}
?>
